...
# ============================================================
# 7. CALCULATE DIATOM PERCENTAGE BIOMASS
# ============================================================

Filtered_data["diatom_percent"] = (
    Filtered_data["diatom"]
    / Filtered_data["HPLCHLA"]
) * 100
...
# ============================================================
# 10. DIATOM PERCENTILE FILTERING
# ============================================================
...
if not diatom_values_for_percentile.empty:
    ...
    raise ValueError(
        "No positive diatom concentrations available."
    )


# ============================================================
# 11. SPECTRAL BAND SELECTION
# ============================================================
...
# IMPORTANT:
# Use the same filtered dataframe for y.
# This preserves the 2–98% diatom filtering.
...
# Align X and y
common_indices = X.index.intersection(
    y.index
)
...
def spa_selection(
    ...
    for spectral feature selection.
    """
...
optimal_bands_spa, optimal_k_spa, best_r2_spa_cv = (
    optimize_spa_bands(
        X,
        y,
        MAX_BANDS_SPA,
...
for method, r2 in results.items():
    ...
    print(
        f"Selected "
        f"{len(selected_bands[method])} "
        f"bands.\n"
    )


# ============================================================
# 20. STORE SELECTED BANDS
# ============================================================
...
# ============================================================
# 21. PLOT SPA-SELECTED WAVELENGTHS
# ============================================================
...
# ============================================================
# 23. REMOVE VERY LOW LOG-DIATOM VALUES
# ============================================================
...
y_test_original_index = (
    y_test.index
)


# ============================================================
# 27. OPTUNA HYPERPARAMETER TUNING
# ============================================================
...
plt.xlabel(
    "Actual Concentration (microgram/L)",
    fontsize=12
)

plt.ylabel(
    "Model Concentration (microgram/L)",
    fontsize=12
)
